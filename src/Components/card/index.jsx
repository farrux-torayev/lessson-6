  ...
  return (
    ...
    <div className="border bg-[#F5F5F5]"> 
      ...
      <div className="w-[1300px]   m-auto flex  ">
        ...
        <div className="w-[400px] pt-[70px]">
          <h1 className="text-[20px] font-[600] pb-[20px] border-b hover:text-blue-600 cursor-pointer">
          Ukraina faqat ukrainaliklardan iborat <br /> tinchlikparvar kontingentiga tayyor  - <br />Zelenskiy
          </h1>
        </div>
        <div className="w-[400px] pt-[70px]">
          <h1 className="text-[20px] font-[600] pb-[20px] border-b hover:text-blue-600 cursor-pointer">
        ...
        <div className="w-[400px] pt-[70px] pb-[20px] border-b hover:text-blue-600 cursor-pointer">
          ...
          AQSh vitse-prezidenti Yevropani <br /> migratsiya siyosatini o‘zgartirishga <br /> chaqirdi
          </h1>
        </div>
        <div className="w-[400px] pt-[70px] pb-[20px] border-b hover:text-blue-600 cursor-pointer">
          <h1 className="text-[20px] font-[600]">
          Olimlar «Novichok» kabi zaharlarni <br /> aniqlaydigan dasturni ishlab chiqdi
          </h1>
        </div>
        <div className="w-[400px] pt-[70px] pb-[20px] border-b hover:text-blue-600 cursor-pointer">
          <h1 className="text-[20px] font-[600]">
          Buyuk Britaniya Rossiya mudofaa vaziri <br /> o‘rinbosari va «Rosatom» tuzilmalariga <br /> qarshi sanksiyalar kiritdi
          </h1>
        </div>
        <div className="w-[400px] pt-[70px] hover:text-blue-600 cursor-pointer">
          <h1 className="text-[20px] font-[600]">
          Zelenskiy Putin bilan muzokara uchun <br /> ultimatum shartini aytdi
          </h1>
        </div>
        </div>
