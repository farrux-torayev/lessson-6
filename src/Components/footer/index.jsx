...
const Footer = () => {
  ...
  return (
    ...
    <div className="py-[30px]">
      ...
      <div className="w-[1300px] m-auto pt-[30px]   bg-white">
        ...
        <div className="pt-[30px]">
          <h1 className="text-[11px] leading-[15px] text-[#B2B2B2] ">
            ...
            Yormatov koʻchasi, 12-uy. Elektron manzil: info@kun.uz. <br />
            Saytda eʼlon qilinayotgan mualliflik maqolalarida keltirilgan
            fikrlar muallifga tegishli va ular Kun.uz tahririyati nuqtayi
            nazarini ifoda etmasligi mumkin. Ⓣ - maqola va materiallarda
